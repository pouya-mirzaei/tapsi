    ...
    <footer className="relative">
      <div className="container flex flex-col items-center justify-center bg-white">
        ...
        <div>
          <img
            src="images/mask.jpg"
            className="w-24 rounded-full object-fill border-8 border-gray-1 absolute left-1/2 top-0 -translate-x-1/2 -translate-y-1/2"
            alt=""
          />
        </div>
        {/* info */}
        <div className="mt-16 flex items-center justify-center flex-col gap-2.5 py-5">
          ...
          <span className="text-xs text-black/70 text-center">
