...
export default function Form() {
  return (
    <div className="basis-7/12 bg-white rounded-xl border-2 border-tertiary p-10 self-stretch">
      {/* title */}
      ...
      <form className="grid grid-cols-2 gap-10 mt-10" autoComplete="off">
        <div className="col-span-full md:col-span-1">
          ...
          <input type="text" id="firstname" className="text-input" placeholder="اسم *" />
        </div>
        <div className="col-span-full md:col-span-1">
          <label className="block text-xs text-black/80 mb-2" htmlFor="email">
            ایمیل شما
          </label>
          <input type="text" id="email" className="text-input" placeholder="ایمیل *" />
        </div>
        <div className="col-span-full">
          <label className="block text-xs text-black/80 mb-2" htmlFor="subject">
            موضوع
          </label>
          <input type="text" id="subject" className="text-input" placeholder="موضوع *" />
        </div>
        <div className="col-span-full">
          ...
          <textarea
            ...
            id="message"
            className="border-2 w-full outline-primary py-2.5 px-3"
            rows={4}
          />
        </div>
        <div className="col-span-full">
