...
export default function LicenseBox({ avatar, title, description, name, role }) {
  return (
    <div className="flex items-center p-6 flex-col border-2 dark:border border-tertiary rounded-xl">
      ...
      <div className="mt-9 text-center">
        ...
        <span className="text-black/70  dark:text-light/80 text-xs">{role}</span>
      </div>
    </div>
  );
}
